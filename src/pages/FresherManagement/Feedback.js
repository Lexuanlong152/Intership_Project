...
class Feedback extends React.Component {
  ...
  handleonClick = async (event) => {
    ...
    if (this.state.course!=="") {
      ...
      if(this.state.course!==this.state.tmp_2)
      {
      this.myFunc(`Get all feedbacks of class with id ${this.state.course} successfully`,'success')
      this.setState({
        tmp_2:this.state.course
      })
      }
    }
    catch(error){
      ...
      {
        this.myFunc(`The class with id ${this.state.course} does not exist`,'danger')
        this.setState({
  ...
  render() {
    ...
    console.log("Check fullname: ",userList)
    const data=[];
    const tmp=[];
    const label=[];
    {
              ...
              <Card className="strpied-tabled-with-hover">
                ...
                <Card.Body className="table-full-width table-responsive px-1">
                    <Table striped hover overflow>
                      <tbody style={{fontSize:"14px",color:"black",fontWeight:"bold",borderTop:"none!important",borderBottom:"none",textAlign:"center"}}>
                        <tr>
                          <td  style={{ fontWeight: "bold",textTransform:"uppercase" }} width="8%"> Acc ID </td>
                          <td  style={{ fontWeight: "bold",textTransform:"uppercase" }} width ="15%"> Full Name</td>
                      
                          <td  style={{ fontWeight: "bold" ,textTransform:"uppercase"}}  hidden={this.state.tableCurrShow == 1 ? false : true}>
                          ...
                          <td  style={{ fontWeight: "bold",textTransform:"uppercase" }}  hidden={this.state.tableCurrShow == 2 ? false : true}>
                          ...
                          <td  style={{ fontWeight: "bold",textTransform:"uppercase" }} hidden={this.state.tableCurrShow == 3 ? false : true}> Logistics</td>
                          <td  style={{ fontWeight: "bold" ,textTransform:"uppercase"}} hidden={this.state.tableCurrShow == 3 ? false : true}>
                            Information to trainees
                          </td>
                          <td  style={{ fontWeight: "bold" ,textTransform:"uppercase"}} hidden={this.state.tableCurrShow == 3 ? false : true}>
                            Class admin's attitude & support
                          </td>
                          <td  style={{ fontWeight: "bold",textTransform:"uppercase" }} hidden={this.state.tableCurrShow == 4 ? false : true} >Other comment</td>
                        </tr>
                        {name!==""&&flagName===true?
                        (userList.map((item, i) => (
                          (item.fullName===name?
