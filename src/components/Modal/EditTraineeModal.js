  ...
  const handleSubmit = async (e) => {
    ...
    // mail validation
      ...
      try {
        ...
        const res = await dispatch(updateFresher({ data, id, classCode })).unwrap();
        ...
        notify("tr", "danger", "Error when updating member or some thing is duplicated", notificationAlertRef);
      }
