      ...
      <div className="d-flex justify-content-start">
        ...
        >
          ...
          <Button
            ...
            onClick={() => handleGetdata(newClass, newMonth, newYear)}
          >
            <FaSearch />
          </Button>
        </div>
          ...
          {page.map((row, i) => {
            ...
            return (
              <tr {...row.getRowProps()}>
                ...
                <td>
                  {
                    isNaN(parseFloat(row.values.gpa).toFixed(2))?  "" : parseFloat(row.values.gpa).toFixed(2)
                  }
                </td>
                <td>
